 ...
 */
@Service
public class PushTopicLevelDetStatusPieSVCImpl implements PushTopicSVC {
	...
	public Object run(TbIotTopicDTO pushItem) throws BizException {
		...
		List<PushTopicLevelDetStatusDTO> result = pushTopicDAO.retrievePushTopicLevelDetStatusPieList(param);
		return result;
	}
